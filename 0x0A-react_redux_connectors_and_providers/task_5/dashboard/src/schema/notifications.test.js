...
describe('App Test Suite', () => {
  ...
  // afterEach(() => {
  // });
  it('getAllNotificationsByUser() is working', () => {
  ...
  it('normalizr returns correct users entity', () => {
    const user = {
      age: 25,
  ...
  it('normalizr returns correct messages entity', () => {
    const message = {
  ...
  it('normalizr returns correct notifications entity', () => {
    const notification = {
